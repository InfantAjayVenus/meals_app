...
var availableMeals = [
  ...
  Meal(
    ...
    categories: [
      availableCategories[0].id,
      availableCategories[4].id,
      availableCategories[9].id,
    ],
